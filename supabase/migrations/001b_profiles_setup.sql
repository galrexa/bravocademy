-- ============================================================
-- STEP 2 — Jalankan SETELAH 001a berhasil
-- Profiles table setup, migration data, trigger
-- ============================================================
...
-- 3. Migrate data lama: ganti 'student' → 'user'
UPDATE public.profiles SET role = 'user' WHERE role = 'student';

-- 4. Update default kolom role
ALTER TABLE public.profiles ALTER COLUMN role SET DEFAULT 'user';

-- 5. Enable Row Level Security
ALTER TABLE public.profiles ENABLE ROW LEVEL SECURITY;

-- 6. Drop policy lama agar idempotent
...
-- 8. Trigger: auto-buat profil saat user baru daftar
